...
namespace CommonUtils.Tests
{
	...
	public static class FFTTesting
	{
		...
		public static void FFTWTestUsingDoubleFFTWLIBR2R_INPLACE(string CSVFilePath=null, double[] audio_data=null, int testLoopCount=1) {
			...
			for (int i = 0; i < testLoopCount; i++) {
				// perform the FFT
				FFTUtils.FFTW_FFT_R2R(ref audio_data, ref audio_data, N, FFTUtils.FFTMethod.DFT);
			}
		...
		public static void FFTWTestUsingDoubleFFTWLIBR2R(string CSVFilePath=null, double[] audio_data=null, int testLoopCount=1) {
			...
			// perform the IFFT
			FFTUtils.FFTW_FFT_R2R(ref dout, ref dout2, N, FFTUtils.FFTMethod.IDFT);
		...
		public static void TimeSpectrograms(float[] data=null) {
			...
			sw.Stop();
			Console.Out.WriteLine("CreateSpectrogramFFTW: Time used: {0} ms",sw.Elapsed.TotalMilliseconds);
		...
		#region test data
		public static double[] GetSignalTestData() {
			return new double[] {
				0.000865391,
				0.104118064,
				-0.105368771,
		...
		public static double[] MatLabSpectrumFFTReal() {
			return new double[] {
				-1.037635295,
				0.663001566,
				-0.943641744,
		...
		public static double[] MatLabSpectrumFFTImag() {
			return new double[] {
				0,
				-2.340346849,
				1.50382509,
		...
		public static double[] MatLabSpectrumFFTAbs() {
			return new double[] {
				1.037635295,
				2.432446186,
				1.7753731,
		...
		public static double[] MatLabSpectrumIFFTReal() {
			return new double[] {
				0.000865391,
				0.104118064,
				-0.105368771,
		...
		public static double[] MatLabSpectrumIFFTImag() {
			return new double[256];
		}
		
		public static double[] MatLabSpectrumIFFTAbs() {
			return new double[] {
				0.000865391,
				0.104118064,
				0.105368771,
